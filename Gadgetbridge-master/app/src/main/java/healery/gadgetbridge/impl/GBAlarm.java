...
import static healery.gadgetbridge.devices.miband.MiBandConst.PREF_MIBAND_ALARMS;
...
public class GBAlarm implements Alarm {
    ...
    public void store() {
        ...
        Set<String> preferencesAlarmListSet = prefs.getStringSet(MiBandConst.PREF_MIBAND_ALARMS, new HashSet<String>());
        ...
        prefs.getPreferences().edit().putStringSet(MiBandConst.PREF_MIBAND_ALARMS, newPrefs).apply();
    }
