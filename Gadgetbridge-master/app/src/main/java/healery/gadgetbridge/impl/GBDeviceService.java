...
package healery.gadgetbridge.impl;
...
import healery.gadgetbridge.util.JavaExtensions;
import healery.gadgetbridge.util.LanguageUtils;
import healery.gadgetbridge.GBApplication;
import healery.gadgetbridge.R;

import static healery.gadgetbridge.util.JavaExtensions.coalesce;
...
public class GBDeviceService implements DeviceService {
    ...
    public void onNotification(NotificationSpec notificationSpec) {
        Intent intent = createIntent().setAction(ACTION_NOTIFICATION)
                ...
                .putExtra(EXTRA_NOTIFICATION_SENDER, JavaExtensions.coalesce(notificationSpec.sender, getContactDisplayNameByNumber(notificationSpec.phoneNumber)))
    ...
    public void onSetCallState(CallSpec callSpec) {
        ...
        if (currentPrivacyMode.equals(context.getString(R.string.p_call_privacy_mode_name))) {
            ...
            callSpec.name = JavaExtensions.coalesce(callSpec.name, getContactDisplayNameByNumber(callSpec.number));
