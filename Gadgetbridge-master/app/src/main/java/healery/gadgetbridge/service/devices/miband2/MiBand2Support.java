...
import healery.gadgetbridge.deviceevents.GBDeviceEventBatteryInfo;
import healery.gadgetbridge.deviceevents.GBDeviceEventFindPhone;
import healery.gadgetbridge.deviceevents.GBDeviceEventVersionInfo;
...
import healery.gadgetbridge.entities.User;
import healery.gadgetbridge.service.devices.miband2.actions.StopNotificationAction;
...
import healery.gadgetbridge.service.devices.miband2.operations.InitOperation;
import healery.gadgetbridge.service.devices.miband2.operations.UpdateFirmwareOperation;
...
import healery.gadgetbridge.deviceevents.GBDeviceEventFindPhone;
import healery.gadgetbridge.deviceevents.GBDeviceEventVersionInfo;
import healery.gadgetbridge.devices.SampleProvider;
import healery.gadgetbridge.devices.huami.ActivateDisplayOnLift;
...
import healery.gadgetbridge.devices.huami.miband2.MiBand2FWHelper;
import healery.gadgetbridge.devices.miband.DateTimeDisplay;
import healery.gadgetbridge.devices.miband.DoNotDisturb;
import healery.gadgetbridge.devices.miband.MiBand2SampleProvider;
import healery.gadgetbridge.devices.miband.MiBand2Service;
import healery.gadgetbridge.devices.miband.MiBandConst;
import healery.gadgetbridge.devices.miband.MiBandCoordinator;
import healery.gadgetbridge.devices.miband.MiBandService;
...
import healery.gadgetbridge.impl.GBDevice.State;
import healery.gadgetbridge.model.ActivitySample;
import healery.gadgetbridge.model.ActivityUser;
import healery.gadgetbridge.model.Alarm;
import healery.gadgetbridge.model.CalendarEventSpec;
import healery.gadgetbridge.model.CalendarEvents;
...
import healery.gadgetbridge.service.btle.AbstractBTLEDeviceSupport;
...
import healery.gadgetbridge.service.btle.GattService;
import healery.gadgetbridge.service.btle.TransactionBuilder;
import healery.gadgetbridge.service.btle.actions.AbortTransactionAction;
import healery.gadgetbridge.service.btle.actions.SetDeviceStateAction;
import healery.gadgetbridge.service.btle.profiles.alertnotification.AlertCategory;
import healery.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import healery.gadgetbridge.service.btle.profiles.heartrate.HeartRateProfile;
import healery.gadgetbridge.service.devices.common.SimpleNotification;
import healery.gadgetbridge.service.devices.huami.HuamiDeviceEvent;
import healery.gadgetbridge.service.devices.miband.NotificationStrategy;
import healery.gadgetbridge.service.devices.miband.RealtimeSamplesSupport;
import healery.gadgetbridge.service.devices.miband2.actions.StopNotificationAction;
import healery.gadgetbridge.service.devices.miband2.operations.FetchActivityOperation;
import healery.gadgetbridge.service.devices.miband2.operations.FetchSportsSummaryOperation;
import healery.gadgetbridge.service.devices.miband2.operations.InitOperation;
...
import healery.gadgetbridge.util.NotificationUtils;
import healery.gadgetbridge.util.Prefs;
import healery.gadgetbridge.util.Version;

import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static healery.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static healery.gadgetbridge.devices.miband.MiBandConst.FLASH_COLOUR;
import static healery.gadgetbridge.devices.miband.MiBandConst.FLASH_COUNT;
import static healery.gadgetbridge.devices.miband.MiBandConst.FLASH_DURATION;
import static healery.gadgetbridge.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static healery.gadgetbridge.devices.miband.MiBandConst.VIBRATION_COUNT;
import static healery.gadgetbridge.devices.miband.MiBandConst.VIBRATION_DURATION;
import static healery.gadgetbridge.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static healery.gadgetbridge.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static healery.gadgetbridge.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static healery.gadgetbridge.devices.miband.MiBandConst.getNotificationPrefStringValue;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(DeviceInfoProfile.ACTION_DEVICE_INFO)) {
                handleDeviceInfo((healery.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
    ...
    public void logHeartrate(byte[] value, int status) {
        if (status == BluetoothGatt.GATT_SUCCESS && value != null) {
            ...
            if (value.length == 2 && value[0] == 0) {
                ...
                System.out.println("heart: " + hrValue);
            }
            return;
        }
        logMessageContent(value);
...
//        }
    ...
    private void handleDeviceInfo(healery.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo info) {
