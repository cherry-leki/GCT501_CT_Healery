...
import healery.gadgetbridge.database.DBOpenHelper;
import healery.gadgetbridge.devices.DeviceManager;
import healery.gadgetbridge.entities.DaoMaster;
import healery.gadgetbridge.externalevents.BluetoothStateChangeReceiver;
import healery.gadgetbridge.impl.GBDevice;
import healery.gadgetbridge.impl.GBDeviceService;
import healery.gadgetbridge.model.ActivityUser;
import healery.gadgetbridge.model.DeviceService;
import healery.gadgetbridge.service.NotificationCollectorMonitorService;
import healery.gadgetbridge.util.AndroidUtils;
import healery.gadgetbridge.util.FileUtils;
import healery.gadgetbridge.util.GB;
import healery.gadgetbridge.util.GBPrefs;
import healery.gadgetbridge.util.LimitedQueue;
...
public class GBApplication extends Application {
    ...
    public static final String ACTION_QUIT
            = "healery.gadgetbridge.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "healery.gadgetbridge.gbapplication.action.language_change";
    ...
    public void onCreate() {
        ...
        if (isRunningMarshmallowOrLater()) {
            ...
            if(isRunningOreoOrLater()) {
                NotificationChannel channel = notificationManager.getNotificationChannel(GB.NOTIFICATION_CHANNEL_ID);
                if(channel == null) {
                    channel = new NotificationChannel(GB.NOTIFICATION_CHANNEL_ID,
